...
export default function EasyCoursesPage() {
  ...
  const { setInstructor, setCourseNumber, setDepartment, setSubj } = useStore();
                          ...
                          >
                            ...
                            >
                              <button
                                ...
                                onClick={() => {
                                  setCourseNumber(courses[0].course_nbr);
                                  setSubj(courses[0].subj_cd);
                                  setDepartment(courses[0].dept_name);
                                }}
                              >
                                {courses[0].subj_cd +
                                  " " +
